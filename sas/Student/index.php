                  ...
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php
                          echo (isset($studentData['firstName']) ? $studentData['firstName'] : '') . ' ' .
                               (isset($studentData['lastName']) ? $studentData['lastName'] : '') . ' ' .
                               (isset($studentData['otherName']) ? $studentData['otherName'] : '');
                        ?>
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                        <?php echo isset($studentData['admissionNumber']) ? $studentData['admissionNumber'] : ''; ?>
                      </div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo isset($studentData['dateCreated']) ? $studentData['dateCreated'] : ''; ?></div>
                    </div>
                    <div class="col-auto">
